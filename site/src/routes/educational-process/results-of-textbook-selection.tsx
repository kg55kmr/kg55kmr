          ...
          <Fragment key={v.academicYear}>
            ...
            {v.items.map((item) => (
              <tr key={item.url}>
                <td>{item.class}</td>
                <td>
                  {item.type === "order" ? " замовлення" : " дозамовлення"}
                </td>
                <td>
    ...
    items: [
      {
        class: 4,
        type: "order",
        url: "https://drive.google.com/file/d/1EFMCh2JWB9ZejTzB5dt75rVDZ6YpmkzO/view",
        protocol:
          "https://drive.google.com/file/d/1InZO_bvWiPkY_XnUtNzT8Wdc2tQXMHmS/view",
      },
      {
        class: 6,
        type: "order",
        url: "https://drive.google.com/file/d/1jHxecD4aUAsmNU0ZQKdAjmsvwvhNbXJE/view",
        protocol:
          "https://drive.google.com/file/d/1InZO_bvWiPkY_XnUtNzT8Wdc2tQXMHmS/view",
      },
      {
        class: 7,
        type: "order",
        url: "https://drive.google.com/file/d/1HyZy_WzkbWaQ9LG3eJV19lAdDsFOClXp/view",
        protocol:
          "https://drive.google.com/file/d/1InZO_bvWiPkY_XnUtNzT8Wdc2tQXMHmS/view",
      },
      {
        class: 9,
        type: "order",
        url: "https://drive.google.com/file/d/19zwApA2QQtnO0arNqK7HXHT2Ypxv5UwQ/view",
        protocol:
          "https://drive.google.com/file/d/1InZO_bvWiPkY_XnUtNzT8Wdc2tQXMHmS/view",
      },
    ],
